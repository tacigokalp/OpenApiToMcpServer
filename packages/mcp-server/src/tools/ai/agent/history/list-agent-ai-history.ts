...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/ai/{projectId}/agent/history',
  operationId: 'getChatHistory',
};

export const tool: Tool = {
  name: 'list_agent_ai_history',
  description:
...
export const handler = async (client: Openapitomcpstainless, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.ai.agent.history.list(projectId)));
};
