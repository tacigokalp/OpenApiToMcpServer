...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/organizations/{organizationId}/workspaces/{workspaceId}/projects',
  operationId: 'listProjects_1',
};

export const tool: Tool = {
  name: 'list_workspaces_organizations_projects',
  description:
...
export const handler = async (client: Openapitomcpstainless, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.organizations.workspaces.projects.list(workspaceId, body)),
  );
};
