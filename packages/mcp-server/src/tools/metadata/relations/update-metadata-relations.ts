...
export const tool: Tool = {
  name: 'update_metadata_relations',
  description: 'Update Relation From Metadata',
  inputSchema: {
    type: 'object',
    properties: {
      projectId: {
...
export const handler = async (client: Openapitomcpstainless, args: Record<string, unknown> | undefined) => {
  ...
  return asBinaryContentResult(await client.metadata.relations.update(relationId, body));
};
