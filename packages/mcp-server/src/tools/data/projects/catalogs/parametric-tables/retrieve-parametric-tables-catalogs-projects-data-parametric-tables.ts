...
export const tool: Tool = {
  name: 'retrieve_parametric_tables_catalogs_projects_data_parametric_tables',
  description:
...
export const handler = async (client: Openapitomcpstainless, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      jq_filter,
      await client.data.projects.catalogs.parametricTables.retrieveParametricTables(catalogId, body),
    ),
  );
};
