import fs from 'fs';
import type { ResponseLike } from 'openapitomcpstainless/internal/to-file';
import { toFile } from 'openapitomcpstainless/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('openapitomcpstainless/core/uploads');
    await expect(
