...
import { APIPromise } from 'openapitomcpstainless/core/api-promise';

import util from 'node:util';
import Openapitomcpstainless from 'openapitomcpstainless';
import { APIUserAbortError } from 'openapitomcpstainless';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['OPENAPITOMCPSTAINLESS_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Openapitomcpstainless) => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Openapitomcpstainless({ logger: logger, logLevel: 'debug', apiKey: 'My API Key' });
    ...
    test('default logLevel is warn', async () => {
      const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Openapitomcpstainless({ logger: logger, logLevel: 'info', apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['OPENAPITOMCPSTAINLESS_LOG'] = 'debug';
      const client = new Openapitomcpstainless({ logger: logger, apiKey: 'My API Key' });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['OPENAPITOMCPSTAINLESS_LOG'] = 'not a log level';
      const client = new Openapitomcpstainless({ logger: logger, apiKey: 'My API Key' });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'OPENAPITOMCPSTAINLESS_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['OPENAPITOMCPSTAINLESS_LOG'] = 'debug';
      const client = new Openapitomcpstainless({ logger: logger, logLevel: 'off', apiKey: 'My API Key' });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['OPENAPITOMCPSTAINLESS_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Openapitomcpstainless({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['OPENAPITOMCPSTAINLESS_BASE_URL'] = 'https://example.com/from_env';
      const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['OPENAPITOMCPSTAINLESS_BASE_URL'] = ''; // empty
      const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://partner.peaka.studio/api/v1');
    });

    test('blank env variable', () => {
      process.env['OPENAPITOMCPSTAINLESS_BASE_URL'] = '  '; // blank
      const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://partner.peaka.studio/api/v1');
    });
    ...
    test('env variable with environment', () => {
      ...
      expect(
        () => new Openapitomcpstainless({ apiKey: 'My API Key', environment: 'production' }),
    ...
    test('in request options overridden by env variable', () => {
      process.env['OPENAPITOMCPSTAINLESS_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Openapitomcpstainless({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Openapitomcpstainless({ apiKey: 'My API Key' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['OPENAPITOMCPSTAINLESS_API_KEY'] = 'My API Key';
    const client = new Openapitomcpstainless();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['OPENAPITOMCPSTAINLESS_API_KEY'] = 'another My API Key';
    const client = new Openapitomcpstainless({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Openapitomcpstainless({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Openapitomcpstainless({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Openapitomcpstainless({ apiKey: 'My API Key', fetch: testFetch });
