...
export class Columns extends APIResource {
   ...
   * ```ts
   * const column =
   *   await client.data.projects.table.columns.create(
   *     'tableName',
   *     { projectId: 'projectId' },
   *   );
   *
  ...
  create(tableName: string, params: ColumnCreateParams, options?: RequestOptions): APIPromise<Response> {
    ...
    return this._client.post(path`/data/projects/${projectId}/table/${tableName}/columns`, {
      body,
      ...options,
   ...
   * ```ts
   * const column =
   *   await client.data.projects.table.columns.update(
   *     'columnName',
  ...
  update(columnName: string, params: ColumnUpdateParams, options?: RequestOptions): APIPromise<Response> {
    ...
    return this._client.put(path`/data/projects/${projectId}/table/${tableName}/columns/${columnName}`, {
      body,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
      __binaryResponse: true,
   ...
   * ```ts
   * const columns =
   *   await client.data.projects.table.columns.list(
   *     'tableName',
   *     { projectId: 'projectId' },
   *   );
   *
  ...
  list(tableName: string, params: ColumnListParams, options?: RequestOptions): APIPromise<Response> {
    ...
    return this._client.get(path`/data/projects/${projectId}/table/${tableName}/columns`, {
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
      __binaryResponse: true,
    });
   ...
   * @example
   * ```ts
   * await client.data.projects.table.columns.delete(
   *   'columnName',
   *   { projectId: 'projectId', tableName: 'tableName' },
   * );
   * ```
  ...
  delete(columnName: string, params: ColumnDeleteParams, options?: RequestOptions): APIPromise<void> {
    ...
    return this._client.delete(path`/data/projects/${projectId}/table/${tableName}/columns/${columnName}`, {
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
  }
